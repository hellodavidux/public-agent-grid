...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        blue: 'bg-blue-600 text-white shadow hover:bg-blue-800',
        default:
        ...
        destructiveOutline:
          'border border-destructive/25 text-destructive bg-background shadow-sm hover:bg-destructive/5',
        destructiveGhost: 'text-destructive  hover:bg-destructive/10',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        'destructive-secondary': 'bg-destructive/10 text-destructive hover:bg-destructive/20',
        muted: 'bg-muted hover:bg-muted/80 text-left gap-2',
      },
      size: {
